...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    OKAllCharactersTableViewController* vc = [OKAllCharactersTableViewController new];
    OKNavigationViewController* nav = [[OKNavigationViewController alloc] initWithRootViewController:vc];
